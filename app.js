...
window.emailInvoice = function(customerId){
  ...
  window.location.href=`mailto:${encodeURIComponent(c.email)}?subject=${encodeURIComponent("Invoice from "+COMPANY.name)}&body=${encodeURIComponent(`Hello ${c.name},\n\nBelow is your invoice summary from ${COMPANY.name}.\n\nTotal paid: ${money(t.paid)}\nBalance due: ${money(t.owed)}\n\nPayment is due upon receipt.\n\nThank you for your business.\n\n${COMPANY.name}\n${COMPANY.phone}\n${COMPANY.email}`)}`;
};
